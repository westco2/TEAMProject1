...
<div >
    <h3 align="center" style="color: #7D4214;" class="div_center">${sch } 검색결과</h3>
    <b>${list.size()}개의 검색결과</b> 
    <a href="search.post?search=${sch }&sort=pno">최신순</a>
    <a href="search.post?search=${sch }&sort=hit">인기순</a>
    <a href="search.post?search=${sch }&sort=num">찜순위</a>
    <a href="search.post?search=${sch }&sort=price">가격순</a>
